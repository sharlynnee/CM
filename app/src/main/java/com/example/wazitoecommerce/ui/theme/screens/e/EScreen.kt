package com.example.wazitoecommerce.ui.theme.screens.e
...
@Composable
fun MyForm(navController: NavController){
    Column(modifier = Modifier
        .fillMaxSize()
        .paint(
            painterResource(id = R.drawable.b7),
...
@Composable
fun MyFormPreview(){
    MyForm(navController = rememberNavController())
